  ...
  render() {
    return (
      <div className="App">
        ...
        <Section
          title={'examples'}
          content={<Examples accentColor={'cyan'} entries={this.state.exampleEntries} images={[cbcImg]}/>}
        />
        <Section
          title={'resources'}
          content={<Resources entries={this.state.resourceEntries} images={[illustratorImg,affinityImg]}/>}
